Yamato Tracking API - .Net
================================
Use .Net to track Yamato shipments with Yamato Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "506015912835";
                  createTrackingParams.courierCode = "taqbin-jp";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  {
                      trackingNumber = "478851125141",
                      courierCode = "taqbin-jp"
                  };
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "478851125141,506424226700";
                  getTrackingResultsParams.courierCode = "taqbin-jp";
