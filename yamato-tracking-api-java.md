Yamato Tracking API - Java
================================
Use Java to track Yamato shipments with Yamato Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.taqbinjp;
    ...
    public class CreateYamatoTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("506015912835");
                createTrackingParams.setCourierCode("taqbin-jp");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateYamatoTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("478851125141");
                createTrackingParams1.setCourierCode("taqbin-jp");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("506424226700");
                createTrackingParams2.setCourierCode("taqbin-jp");
...
Get status of the shipment:
    ...
    public class GetYamatoTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("478851125141,506424226700");
                trackingParams.setCourierCode("taqbin-jp");
...
Update a tracking by ID:
    ...
    public class UpdateYamatoTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "9d8a47f58975ac058f8cc212dd456ba5";
