# TrackingMore: Yamato Tracking API & Webhook
[Yamato Tracking API](https://www.trackingmore.com/taqbin-jp-tracking-api.html) enables you to connect tracking info of Yamato shipments into your system, improving shipment visibility. 

Besides [Yamato Tracking](https://www.trackingmore.com/taqbin-jp-tracking.html), TrackingMore supports shipment tracking across 1,200+ global carriers through a robust [multi-carrier shipment tracking API](https://www.trackingmore.com/tracking-api).
...
### Features
   *  Unified real-time tracking information for Yamato shipments.
