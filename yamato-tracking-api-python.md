Yamato Tracking API - Python
================================
Use Python to track Yamato shipments with Yamato Tracking API.
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    try:
      params = [
        {'tracking_number': '478851125141', 'courier_code': 'taqbin-jp'},
        {'tracking_number': '506424226700', 'courier_code': 'taqbin-jp'}
      ]
...
Get status of the shipment:
    ...
    try:
      ...
      # params = {'tracking_numbers': '506424226700,506015912835', 'courier_code': 'taqbin-jp'}
